    ...
    <div style="background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 4px; padding: 30px; max-width: 600px;">
        ...
        <form method="POST" action="{{ route('departments.update', $department) }}">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name', $department->name) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('name') border-color: #dc3545; @enderror">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <textarea name="description" rows="4" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('description') border-color: #dc3545; @enderror">{{ old('description', $department->description) }}</textarea>
