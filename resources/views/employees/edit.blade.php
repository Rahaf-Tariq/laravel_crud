    ...
    <div style="background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 4px; padding: 30px; max-width: 600px;">
        ...
        <form method="POST" action="{{ route('employees.update', $employee) }}">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name', $employee->name) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('name') border-color: #dc3545; @enderror">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="email" name="email" value="{{ old('email', $employee->email) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('email') border-color: #dc3545; @enderror">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="phone" value="{{ old('phone', $employee->phone) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('phone') border-color: #dc3545; @enderror">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="position" value="{{ old('position', $employee->position) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('position') border-color: #dc3545; @enderror">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="number" name="salary" step="0.01" value="{{ old('salary', $employee->salary) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('salary') border-color: #dc3545; @enderror">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="date" name="hire_date" value="{{ old('hire_date', $employee->hire_date) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 13px; @error('hire_date') border-color: #dc3545; @enderror">
